...
public class VelhaFrame extends JFrame {
    ...
    public boolean verifica(String XO) {
        ...
        if ((!"   ".equals(button[0].getText())) && (!"   ".equals(button[1].getText())) && (!"   ".equals(button[2].getText())) && (button[3].getText() != "   ") && (button[4].getText() != "   ") && (button[5].getText() != "   ") && (button[6].getText() != "   ") && (button[7].getText() != "   ") && (button[8].getText() != "   ")) {
            for (int i = 0; i < 9; i++) {
    ...
    public VelhaFrame() {
        ...
        button[0].addActionListener((ActionEvent arg0) -> {
            acao(0);
        });
        button[1].addActionListener((ActionEvent arg0) -> {
            acao(1);
        });
        button[2].addActionListener((ActionEvent arg0) -> {
            acao(2);
        });
        button[3].addActionListener((ActionEvent arg0) -> {
            acao(3);
        });
        button[4].addActionListener((ActionEvent arg0) -> {
            acao(4);
        });
        button[5].addActionListener((ActionEvent arg0) -> {
            acao(5);
        });
        button[6].addActionListener((ActionEvent arg0) -> {
            acao(6);
        });
        button[7].addActionListener((ActionEvent arg0) -> {
            acao(7);
        });
        button[8].addActionListener((ActionEvent arg0) -> {
            acao(8);
        });
